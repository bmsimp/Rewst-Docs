...
{% embed url="https://www.youtube.com/watch?v=xrJ4loXF8JE" %}
...
* 📈 Sam Adams demos a workflow that converts a quote to a project, applies templates, and adds products in CWM
* &#x20;🔄 Phil from SourcePass demos a workflow that updates ConnectWise tickets using SentinelOne data.
