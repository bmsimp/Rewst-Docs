...
For more information, check out our [dymistifying-process-automation.md](../cluck-university/getting-started/automation-strategy/dymistifying-process-automation.md "mention") page in the Getting Started section.
