...
When you're comfortable with the basics of triggers, learn more about [trigger criteria here](./#trigger-criteria). It's a separate submenu within the trigger menu, and has its own documentation page. \
