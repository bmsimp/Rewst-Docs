...
The trigger criteria tab of the trigger menu will only appear if you've chosen a trigger type that works with criteria. This includes [core webhook](./#core-webhook) triggers and any integration-type triggers.

<figure><img src="../../../.gitbook/assets/trigger criteria new gif.gif" alt="An animated image of the user choosing a trigger typed ConnectWise PSA. As the user clicks, a new section of the menu appears titled &#x27;Trigger Criteria.&#x27; The test is white on a dark blue screen."><figcaption><p>Scroll down to the bottom of the trigger menu once you've chosen your trigger type to see the trigger criteria submenu.</p></figcaption></figure>
