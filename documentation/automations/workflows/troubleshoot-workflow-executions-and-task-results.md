...
*   The **Context** section shows variables created or passed between actions. [Context variables](data-input-and-output-input-variables-and-context-variables.md) can change over the execution of the workflow, and each new iteration of variables will be in this list in chronological order.\
    <br>
...
Check the org-level vs. workflow-level execution. Use ![](<../../../.gitbook/assets/Screenshot 2026-04-21 at 10.41.58 AM.png>) **> Execution History > Executions** from the Workflow Builder, or **Automations > Results** in the left side menu of your Rewst platform.
{% endstep %}
