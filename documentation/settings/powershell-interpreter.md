...
{% hint style="warning" %}
To use the PowerShell interpreter, you’ll first need to set up our[ Microsoft Cloud Bundle](../integrations/integration-guides/microsoft-cloud-integration-bundle/), which contains the Azure integration.
{% endhint %}
