...
## What does the Proofpoint integration do?

Our Proofpoint integration enables the automation of email security and compliance. Use the Proofpoint API within Rewst workflows to manage organizations and users.
...
4. Enter the following information into the relevant fields under **Parameters**:
   ...
   3. **Proofpoint User Password**: The password you use for Proofpoint
