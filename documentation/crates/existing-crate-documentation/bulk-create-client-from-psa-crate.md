...
4. Locate the **Required Org Variables** menu on the right of the Crate details page. Click <img src="/broken/files/MtvWtIhQjLxEFARMRWnu" alt="" data-size="line"> to launch the **Add Organization Variable** dialog.\
   \
