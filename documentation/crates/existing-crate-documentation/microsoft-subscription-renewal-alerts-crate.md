...
* Check in your PSA's portal to ensure that the workflow is able to move new devices to their correct location as expected.
* If using ticket creation for your PSA with this workflow, check in your PSA to confirm that tickets are being created when conditions are met.&#x20;
{% endhint %}
...
8. Search for `[REWST - CRATE] M365 Subscription Renewal Alerts`.
9. Click on the workflow to open it in the Workflow Builder.
10. Click <img src="../../../.gitbook/assets/image (196).png" alt="" data-size="line"> to open the edit trigger menu.<br>
...
14. Search for  `[REWST - CRATE] M365 Subscription Renewal Alerts`.
15. Click on the workflow to open it in the Workflow Builder.
16. Click <img src="/broken/files/TvD8yFt1Fk4nu7qDWP00" alt="" data-size="line"> to open the edit trigger menu.<br>
