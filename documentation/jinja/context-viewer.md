...
Click ![](<../../.gitbook/assets/Screenshot 2025-11-26 at 1.57.10 PM.png>)next to any field in your task's right side menu to open the Monaco Editor. Now, the Context Viewer will automatically appear to the left of the Monaco Editor whenever your task has an output schema.
