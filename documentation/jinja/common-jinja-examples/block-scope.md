...
In Jinja, _block scope_ refers to the scope in which a variable exists and is accessible. Block scope is best understood by looking at an example. Consider the following code snippet:
