...
{% tabs %}
{% tab title="CTX" %}
Context Variables are specific to the currently executing workflow. They include variables like [inputs ](../workflows/data-input-and-output.md#workflow-input)from the [workflow's trigger](../intro-to-triggers/), any defined [Data Aliases](../workflows/configuring-your-workflow-tasks/navigating-between-tasks-with-transitions.md#diving-into-data-aliases), and results from tasks that have been executed.
